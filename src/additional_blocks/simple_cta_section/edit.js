...
const BlockEdit = (props) => {
	...
	return (
		<Fragment>
			...
			<div { ...blockProps }>
					<div className="wp-block-hwd-fenzi-simple-cta-section-col wp-block-hwd-fenzi-simple-cta-section-col-left">
					...
					<div className="wp-block-hwd-fenzi-simple-cta-section-col">
